 ...
 *
 * Model version              : 1.1152
 * Simulink Coder version : 8.13 (R2017b) 24-Jul-2017
 * C source code generated on : Thu May  9 19:27:10 2019
 *
...
/* Block signals for system '<S51>/MATLAB Function' */
typedef struct {
  real_T y;                            /* '<S51>/MATLAB Function' */
} B_MATLABFunction_Human_in_Loo_T;

/* Block states (auto storage) for system '<S51>/MATLAB Function' */
typedef struct {
  real_T data_mem[500];                /* '<S51>/MATLAB Function' */
...
typedef struct {
  ...
  real_T SFunction1;                   /* '<S83>/S-Function1' */
  real_T Gain;                         /* '<S32>/Gain' */
  real_T u4low2;                       /* '<S32>/0.4low2' */
  real_T x2k1;                         /* '<S82>/Unit Delay1' */
  real_T x1k1;                         /* '<S82>/Unit Delay' */
  real_T Gain1;                        /* '<S82>/Gain1' */
  real_T Gain2;                        /* '<S82>/Gain2' */
  real_T UnitDelay2;                   /* '<S82>/Unit Delay2' */
  real_T Gain4;                        /* '<S82>/Gain4' */
  real_T Add2;                         /* '<S82>/Add2' */
  real_T Gain3;                        /* '<S82>/Gain3' */
  real_T x2k;                          /* '<S82>/Add1' */
  real_T RT4[2];                       /* '<Root>/RT4' */
  real_T SFunction1_o1;                /* '<S72>/S-Function1' */
  real_T SFunction1_o2;                /* '<S72>/S-Function1' */
  real_T Gain_l;                       /* '<S30>/Gain' */
  real_T Gain1_b;                      /* '<S30>/Gain1' */
  real_T RT5[2];                       /* '<Root>/RT5' */
  real_T SFunction1_o1_k;              /* '<S73>/S-Function1' */
  real_T SFunction1_o2_k;              /* '<S73>/S-Function1' */
  real_T Gain2_h;                      /* '<S30>/Gain2' */
  real_T Gain3_m;                      /* '<S30>/Gain3' */
  real_T x2k1_k;                       /* '<S68>/Unit Delay1' */
  real_T x1k1_m;                       /* '<S68>/Unit Delay' */
  real_T Gain1_m;                      /* '<S68>/Gain1' */
  real_T Gain2_c;                      /* '<S68>/Gain2' */
  real_T UnitDelay2_b;                 /* '<S68>/Unit Delay2' */
  real_T Gain4_g;                      /* '<S68>/Gain4' */
  real_T Add2_m;                       /* '<S68>/Add2' */
  real_T Gain3_k;                      /* '<S68>/Gain3' */
  real_T x2k_i;                        /* '<S68>/Add1' */
  ...
  real_T low_pass_f;                   /* '<S50>/low_pass' */
  real_T low_pass_l;                   /* '<S53>/low_pass' */
  real_T low_pass_d;                   /* '<S54>/low_pass' */
  real_T low_pass_k;                   /* '<S60>/low_pass' */
  real_T low_pass_fc;                  /* '<S59>/low_pass' */
  real_T Delay1[6];                    /* '<S16>/Delay1' */
  real_T Delay5[6];                    /* '<S16>/Delay5' */
  real_T Delay4[6];                    /* '<S16>/Delay4' */
  real_T Delay8[6];                    /* '<S16>/Delay8' */
  real_T Gain_g;                       /* '<S82>/Gain' */
  real_T x1k;                          /* '<S82>/Add' */
  real_T TSamp;                        /* '<S71>/TSamp' */
  real_T Uk1;                          /* '<S71>/UD' */
  real_T Diff;                         /* '<S71>/Diff' */
  real_T u4low1;                       /* '<S30>/0.4low1' */
  real_T UnitDelay;                    /* '<S67>/Unit Delay' */
  real_T UnitDelay1;                   /* '<S67>/Unit Delay1' */
  real_T Add1;                         /* '<S67>/Add1' */
  real_T Gain_p;                       /* '<S67>/Gain' */
  real_T Gain1_d;                      /* '<S67>/Gain1' */
  real_T Add2_i;                       /* '<S67>/Add2' */
  real_T Add3;                         /* '<S67>/Add3' */
  real_T Gain2_i;                      /* '<S67>/Gain2' */
  real_T Gain_io;                      /* '<S68>/Gain' */
  real_T x1k_i;                        /* '<S68>/Add' */
  real_T SFunction1_o;                 /* '<S41>/S-Function1' */
  real_T SFunction1_k;                 /* '<S42>/S-Function1' */
  real_T SFunction1_j;                 /* '<S43>/S-Function1' */
  real_T SFunction1_d;                 /* '<S44>/S-Function1' */
  real_T SFunction1_l;                 /* '<S45>/S-Function1' */
  real_T SFunction1_i;                 /* '<S46>/S-Function1' */
  ...
  real_T high_pass;                    /* '<S55>/high_pass' */
  real_T Abs;                          /* '<S55>/Abs' */
  real_T high_pass_b;                  /* '<S56>/high_pass' */
  real_T Abs_k;                        /* '<S56>/Abs' */
  real_T high_pass_d;                  /* '<S57>/high_pass' */
  real_T Abs_b;                        /* '<S57>/Abs' */
  real_T high_pass_o;                  /* '<S58>/high_pass' */
  real_T Abs_n;                        /* '<S58>/Abs' */
  real_T high_pass_l;                  /* '<S51>/high_pass' */
  real_T Abs_m;                        /* '<S51>/Abs' */
  real_T high_pass_g;                  /* '<S52>/high_pass' */
  real_T Abs_f;                        /* '<S52>/Abs' */
  real_T high_pass_h;                  /* '<S49>/high_pass' */
  real_T Abs_h;                        /* '<S49>/Abs' */
  real_T high_pass_oe;                 /* '<S50>/high_pass' */
  real_T Abs_d;                        /* '<S50>/Abs' */
  real_T high_pass_ba;                 /* '<S53>/high_pass' */
  real_T Abs_j;                        /* '<S53>/Abs' */
  real_T high_pass_hl;                 /* '<S54>/high_pass' */
  real_T Abs_a;                        /* '<S54>/Abs' */
  real_T high_pass_a;                  /* '<S59>/high_pass' */
  real_T Abs_dj;                       /* '<S59>/Abs' */
  real_T high_pass_e;                  /* '<S60>/high_pass' */
  real_T Abs_fy;                       /* '<S60>/Abs' */
  ...
  real_T Data1;                        /* '<S37>/MATLAB Function1' */
  real_T Data2;                        /* '<S37>/MATLAB Function1' */
  real_T E;                            /* '<S37>/Estimation' */
  real_T Time_p[12];                   /* '<S37>/Estimation' */
  real_T Y[12];                        /* '<S37>/Estimation' */
  real_T Y_E[12];                      /* '<S37>/Estimation' */
  real_T est_curve[24];                /* '<S37>/Estimation' */
  ...
  int32_T SFunction1_o3;               /* '<S38>/S-Function1' */
  uint32_T SFunction1_o2_b;            /* '<S38>/S-Function1' */
  uint8_T SFunction1_o1_l[16];         /* '<S38>/S-Function1' */
  boolean_T SFunction1_a;              /* '<S79>/S-Function1' */
  B_Mux_Human_in_Loop_T sf_Mux;        /* '<S32>/Mux' */
  B_Mux_Human_in_Loop_T sf_Mux_p;      /* '<S30>/Mux' */
  B_MATLABFunction_Human_in_Loo_T sf_MATLABFunction_l;/* '<S58>/MATLAB Function' */
  B_MATLABFunction_Human_in_Loo_T sf_MATLABFunction_n;/* '<S57>/MATLAB Function' */
  B_MATLABFunction_Human_in_Loo_T sf_MATLABFunction_m;/* '<S56>/MATLAB Function' */
  B_MATLABFunction_Human_in_Loo_T sf_MATLABFunction_g;/* '<S55>/MATLAB Function' */
  B_MATLABFunction_Human_in_Loo_T sf_MATLABFunction_p;/* '<S52>/MATLAB Function' */
  B_MATLABFunction_Human_in_Loo_T sf_MATLABFunction_g5;/* '<S51>/MATLAB Function' */
...
typedef struct {
  ...
  real_T UnitDelay1_DSTATE;            /* '<S82>/Unit Delay1' */
  real_T UnitDelay_DSTATE;             /* '<S82>/Unit Delay' */
  real_T UnitDelay2_DSTATE;            /* '<S82>/Unit Delay2' */
  real_T UnitDelay1_DSTATE_h;          /* '<S68>/Unit Delay1' */
  real_T UnitDelay_DSTATE_e;           /* '<S68>/Unit Delay' */
  real_T UnitDelay2_DSTATE_a;          /* '<S68>/Unit Delay2' */
  ...
  real_T UnitDelay_DSTATE_j;           /* '<S67>/Unit Delay' */
  real_T UnitDelay1_DSTATE_a;          /* '<S67>/Unit Delay1' */
  ...
  real_T torque_zero;                  /* '<S32>/Data process' */
  ...
  real_T count;                        /* '<S28>/Timer' */
  real_T time;                         /* '<S28>/Timer' */
  real_T last_count;                   /* '<S37>/Estimation' */
  real_T x[20];                        /* '<S37>/Estimation' */
  real_T y[20];                        /* '<S37>/Estimation' */
  real_T theta[2];                     /* '<S37>/Estimation' */
  real_T num;                          /* '<S37>/Estimation' */
  ...
  DW_MATLABFunction_Human_in_Lo_T sf_MATLABFunction_l;/* '<S58>/MATLAB Function' */
  DW_MATLABFunction_Human_in_Lo_T sf_MATLABFunction_n;/* '<S57>/MATLAB Function' */
  DW_MATLABFunction_Human_in_Lo_T sf_MATLABFunction_m;/* '<S56>/MATLAB Function' */
  DW_MATLABFunction_Human_in_Lo_T sf_MATLABFunction_g;/* '<S55>/MATLAB Function' */
  DW_MATLABFunction_Human_in_Lo_T sf_MATLABFunction_p;/* '<S52>/MATLAB Function' */
  DW_MATLABFunction_Human_in_Lo_T sf_MATLABFunction_g5;/* '<S51>/MATLAB Function' */
} DW_Human_in_Loop_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T low_pass_CSTATE[2];           /* '<S49>/low_pass' */
  real_T low_pass_CSTATE_o[2];         /* '<S50>/low_pass' */
  real_T low_pass_CSTATE_n[2];         /* '<S53>/low_pass' */
  real_T low_pass_CSTATE_p[2];         /* '<S54>/low_pass' */
  real_T low_pass_CSTATE_on[2];        /* '<S60>/low_pass' */
  real_T low_pass_CSTATE_f[2];         /* '<S59>/low_pass' */
  real_T high_pass_CSTATE[4];          /* '<S55>/high_pass' */
  real_T high_pass_CSTATE_b[4];        /* '<S56>/high_pass' */
  real_T high_pass_CSTATE_c[4];        /* '<S57>/high_pass' */
  real_T high_pass_CSTATE_m[4];        /* '<S58>/high_pass' */
  real_T high_pass_CSTATE_a[4];        /* '<S51>/high_pass' */
  real_T high_pass_CSTATE_my[4];       /* '<S52>/high_pass' */
  real_T high_pass_CSTATE_p[2];        /* '<S49>/high_pass' */
  real_T high_pass_CSTATE_n[2];        /* '<S50>/high_pass' */
  real_T high_pass_CSTATE_pw[2];       /* '<S53>/high_pass' */
  real_T high_pass_CSTATE_k[2];        /* '<S54>/high_pass' */
  real_T high_pass_CSTATE_l[2];        /* '<S59>/high_pass' */
  real_T high_pass_CSTATE_h[2];        /* '<S60>/high_pass' */
} X_Human_in_Loop_T;
...
typedef struct {
  ...
  boolean_T low_pass_CSTATE_o[2];      /* '<S50>/low_pass' */
  boolean_T low_pass_CSTATE_n[2];      /* '<S53>/low_pass' */
  boolean_T low_pass_CSTATE_p[2];      /* '<S54>/low_pass' */
  boolean_T low_pass_CSTATE_on[2];     /* '<S60>/low_pass' */
  boolean_T low_pass_CSTATE_f[2];      /* '<S59>/low_pass' */
  boolean_T high_pass_CSTATE[4];       /* '<S55>/high_pass' */
  boolean_T high_pass_CSTATE_b[4];     /* '<S56>/high_pass' */
  boolean_T high_pass_CSTATE_c[4];     /* '<S57>/high_pass' */
  boolean_T high_pass_CSTATE_m[4];     /* '<S58>/high_pass' */
  boolean_T high_pass_CSTATE_a[4];     /* '<S51>/high_pass' */
  boolean_T high_pass_CSTATE_my[4];    /* '<S52>/high_pass' */
  boolean_T high_pass_CSTATE_p[2];     /* '<S49>/high_pass' */
  boolean_T high_pass_CSTATE_n[2];     /* '<S50>/high_pass' */
  boolean_T high_pass_CSTATE_pw[2];    /* '<S53>/high_pass' */
  boolean_T high_pass_CSTATE_k[2];     /* '<S54>/high_pass' */
  boolean_T high_pass_CSTATE_l[2];     /* '<S59>/high_pass' */
  boolean_T high_pass_CSTATE_h[2];     /* '<S60>/high_pass' */
 ...
 * '<S33>'  : 'Human_in_Loop/Sensor Data/Cosmed/COSMED'
 * '<S34>'  : 'Human_in_Loop/Sensor Data/Cosmed/Timer'
 * '<S35>'  : 'Human_in_Loop/Sensor Data/Cosmed/COSMED/DS1202SER_INT_C1_I1'
 * '<S36>'  : 'Human_in_Loop/Sensor Data/Cosmed/COSMED/DS1202SER_SETUP_C1'
 * '<S37>'  : 'Human_in_Loop/Sensor Data/Cosmed/COSMED/Serial Decoding System'
 * '<S38>'  : 'Human_in_Loop/Sensor Data/Cosmed/COSMED/Serial Decoding System/DS1202SER_RX_C1'
 * '<S39>'  : 'Human_in_Loop/Sensor Data/Cosmed/COSMED/Serial Decoding System/Estimation'
 * '<S40>'  : 'Human_in_Loop/Sensor Data/Cosmed/COSMED/Serial Decoding System/MATLAB Function1'
 * '<S41>'  : 'Human_in_Loop/Sensor Data/EMG module/ADC_CLASS1_BL1'
 * '<S42>'  : 'Human_in_Loop/Sensor Data/EMG module/ADC_CLASS1_BL2'
 * '<S43>'  : 'Human_in_Loop/Sensor Data/EMG module/ADC_CLASS1_BL3'
 * '<S44>'  : 'Human_in_Loop/Sensor Data/EMG module/ADC_CLASS1_BL4'
 * '<S45>'  : 'Human_in_Loop/Sensor Data/EMG module/ADC_CLASS1_BL5'
 * '<S46>'  : 'Human_in_Loop/Sensor Data/EMG module/ADC_CLASS1_BL6'
 * '<S47>'  : 'Human_in_Loop/Sensor Data/EMG module/Mux1'
 * '<S48>'  : 'Human_in_Loop/Sensor Data/EMG module/Mux3'
 * '<S49>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing'
 * '<S50>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing1'
 * '<S51>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing10'
 * '<S52>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing11'
 * '<S53>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing2'
 * '<S54>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing3'
 * '<S55>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing4'
 * '<S56>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing5'
 * '<S57>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing6'
 * '<S58>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing7'
 * '<S59>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing8'
 * '<S60>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing9'
 * '<S61>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing10/MATLAB Function'
 * '<S62>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing11/MATLAB Function'
 * '<S63>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing4/MATLAB Function'
 * '<S64>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing5/MATLAB Function'
 * '<S65>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing6/MATLAB Function'
 * '<S66>'  : 'Human_in_Loop/Sensor Data/EMG module/Preprocessing7/MATLAB Function'
 * '<S67>'  : 'Human_in_Loop/Sensor Data/Encoder module/1-Order TD'
 * '<S68>'  : 'Human_in_Loop/Sensor Data/Encoder module/2-Order TD'
 * '<S69>'  : 'Human_in_Loop/Sensor Data/Encoder module/Data process'
 * '<S70>'  : 'Human_in_Loop/Sensor Data/Encoder module/Data process1'
 * '<S71>'  : 'Human_in_Loop/Sensor Data/Encoder module/Discrete Derivative'
 * '<S72>'  : 'Human_in_Loop/Sensor Data/Encoder module/EMC_ENCODER_BL1'
 * '<S73>'  : 'Human_in_Loop/Sensor Data/Encoder module/EMC_ENCODER_BL3'
 * '<S74>'  : 'Human_in_Loop/Sensor Data/Encoder module/Encoder Power Setup1'
 * '<S75>'  : 'Human_in_Loop/Sensor Data/Encoder module/Encoder Power Setup3'
 * '<S76>'  : 'Human_in_Loop/Sensor Data/Encoder module/Mux'
 * '<S77>'  : 'Human_in_Loop/Sensor Data/Encoder module/Mux1'
 * '<S78>'  : 'Human_in_Loop/Sensor Data/Encoder module/Mux2'
 * '<S79>'  : 'Human_in_Loop/Sensor Data/FootSwitch module/DIO_CLASS1_BIT_IN_BL1'
 * '<S80>'  : 'Human_in_Loop/Sensor Data/FootSwitch module/DIO_CLASS1_BIT_OUT_BL1'
 * '<S81>'  : 'Human_in_Loop/Sensor Data/FootSwitch module/FootSwitch Filter'
 * '<S82>'  : 'Human_in_Loop/Sensor Data/Torque module/2-Order TD'
 * '<S83>'  : 'Human_in_Loop/Sensor Data/Torque module/ADC_CLASS1_BL6'
 * '<S84>'  : 'Human_in_Loop/Sensor Data/Torque module/Data process'
 * '<S85>'  : 'Human_in_Loop/Sensor Data/Torque module/MATLAB Function'
 * '<S86>'  : 'Human_in_Loop/Sensor Data/Torque module/Mux'
 * '<S87>'  : 'Human_in_Loop/State Module/Mux1'
 * '<S88>'  : 'Human_in_Loop/State Module/State Machine'
 */
