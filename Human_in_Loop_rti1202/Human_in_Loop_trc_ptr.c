...
volatile real_T *p_2_Human_in_Loop_real_T_2 = NULL;
volatile real_T *p_2_Human_in_Loop_real_T_3 = NULL;
volatile real_T *p_2_Human_in_Loop_real_T_4 = NULL;
volatile real_T *p_2_Human_in_Loop_real_T_5 = NULL;
volatile real_T *p_2_Human_in_Loop_real_T_6 = NULL;
volatile real_T *p_2_Human_in_Loop_real_T_7 = NULL;
...
static void rti_init_trc_pointers_0(void)
{
  ...
  p_2_Human_in_Loop_int8_T_1 = &Human_in_Loop_DW.RT4_write_buf;
  p_2_Human_in_Loop_real_T_2 = &Human_in_Loop_DW.sf_MATLABFunction_l.data_mem[0];
  p_2_Human_in_Loop_real_T_3 = &Human_in_Loop_DW.sf_MATLABFunction_n.data_mem[0];
  p_2_Human_in_Loop_real_T_4 = &Human_in_Loop_DW.sf_MATLABFunction_m.data_mem[0];
  p_2_Human_in_Loop_real_T_5 = &Human_in_Loop_DW.sf_MATLABFunction_g.data_mem[0];
  p_2_Human_in_Loop_real_T_6 = &Human_in_Loop_DW.sf_MATLABFunction_p.data_mem[0];
  p_2_Human_in_Loop_real_T_7 = &Human_in_Loop_DW.sf_MATLABFunction_g5.data_mem[0];
