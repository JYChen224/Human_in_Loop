/************************ dSPACE target specific file *************************
   ...
   Include file .\data1_rti1202\data1_th.c :

   Task Configuration file for model : data1

   RTI1202 7.9 (02-Nov-2017)/2.17
   15-May-2019 17:48:49
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\data1_rti1202\data1_th.c is for ST).
# endif
